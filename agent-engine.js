...
function fallbackAnalysis(question, hits) {
  ...
  return {
    answer: `## الرأي القانوني الأولي\n\nالمسألة تحتاج إلى مطابقة الوقائع بالقاعدة القانونية وتحديد الصفة والاختصاص والمواعيد وعبء الإثبات قبل الجزم بالنتيجة.\n\n## المراجع القانونية ذات الصلة\n\n${sourceLines}\n\n## ما يلزم لاستكمال الرأي\n\nحدد أطراف النزاع، التسلسل الزمني، الطلب المطلوب، المحكمة أو الجهة المختصة، والمستندات المتاحة. بعد ذلك تُفحص الدفوع الشكلية والموضوعية، وقوة الإثبات، والمخاطر العملية.\n\n> هذا رأي معلوماتي أولي وليس حكمًا قضائيًا أو استشارة ملزمة.`,
